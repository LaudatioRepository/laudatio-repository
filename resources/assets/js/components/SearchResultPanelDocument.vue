                ...
                <div class="panel-heading">
                 ...
                 <div :id="documentresultdata._id" class="panel-collapse collapse">
                    <div   class="panel-body">
                        <div class="iconwrapper"  v-if="typeof documentresult.corpusByDocument[documentresultdata._id]  != 'undefined'"><i class="fa fa-book" aria-hidden="true"></i> Corpus:  {{ fromCorpus = documentresult.corpusByDocument[documentresultdata._id].corpus_title | arrayToString }}</div>
