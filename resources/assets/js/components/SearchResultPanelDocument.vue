...
<div class="panel panel-default" v-for="documentresultdata in documentresult.results" v-bind:key="documentresultdata._id">
                <div class="panel-heading">
                    <div class="panel-title"  data-toggle="collapse" data-parent="#accordion" v-bind:data-target="documentresultdata._id | addHash" v-on:click="emitDocumentRelations(documentresultdata._id)">
