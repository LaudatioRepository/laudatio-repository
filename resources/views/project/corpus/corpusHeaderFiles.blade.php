    ...
    @else
        <div class="col">
            <div class="d-flex justify-content-between mt-7 mb-3">
                ...
                <a href="adminEdit_corpus-upload.html" class="btn btn-primary font-weight-bold text-uppercase rounded">
                    File Upload
                </a>
            </div>
            ...
            <p class="mt-5">
                Info: It is only allowed to upload a single Corpus Header file. Uploaded files with the same name will
                be replaced.
            </p>
        </div>
    @endif
