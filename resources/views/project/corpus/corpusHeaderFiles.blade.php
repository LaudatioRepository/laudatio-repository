<div class="col">
    ...
    <div id="corpusFileList">
        <div class="col">
            ...
            <table class="custom-table condensed documents-table table table-bluegrey-dark  table-striped" id="corpus_table">
                ...
                @foreach($corpus_data['filedata']['corpusFileData']['headerData']['elements'] as $fileData)
                    ...
                    <tr>
                        ...
                        <!--td>
                            <a href="javascript:" id="corpusDeleteItem§{{$fileData['basename']}}§{{$fileData['headerObject']->id}}">
