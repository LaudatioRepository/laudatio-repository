...
<div id="browseapp">
        ...
        <div class="container-fluid {{$isLoggedIn ? 'bg-bluegrey-mid' : 'bg-corpus-light'}} bsh-1">
            ...
            <metadata-block-body-annotation :headerdata="headerdata" :headerid="headerid" :header="header" :user="user" :isloggedin="isloggedin" v-show="header == 'annotation'"></metadata-block-body-annotation>
