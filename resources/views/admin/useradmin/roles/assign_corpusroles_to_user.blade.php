...
@section('content')
    ...
    <div class="role-user-container col-lg-10">
        <div class="row">
            ...
            <br />
            <button type="submit" value="Create" id="assignButton" class="btn btn-primary pull-right">Assign users and roles to  {{$corpus->name}}</button>
        </div>
        <input type="hidden" id="_token" value="{{ csrf_token() }}" />
        <input type="hidden" id="corpus_id" value="{{$corpus->id}}" />
    </div>
    <div class="col-lg-12">
